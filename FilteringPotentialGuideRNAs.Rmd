...
test_crispr <- test_crispr %>% 
  select("Name", "# Off-target Sites", "Doench (2014) Activity Score", "Target Sequence", "Zhang (2013) Specificity Score") %>% 
...
write.csv(test_crispr, file = "~/Box Sync/Potential_Guide_RNAs/Filtered_gRNAs/AAP6-like-35_CrisprGuides_CG.csv")
```
